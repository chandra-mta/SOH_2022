...
#
#        copy_msididx_data()        #--- this function is now moved to: update_msididx_data.py (Oct 23, 2018)
...
#
        for nk in range(0, len(msid_short)):
            try:
                ...
                continue
#
#---- the following are commented out and back to the original version (04/08/19)
#            try:
