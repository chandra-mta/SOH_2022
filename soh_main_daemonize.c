...
int main()
{
    ...
    while(1)
    {
        ...
        fp = popen("/data/mta4/Script/SOH/soh_main_script.sh", "r");

        /* check the script runs correctly */

        if (fp == NULL){
            fo  = fopen("/data/mta4/Script/SOH/Logs/soh_main_log", "2");
        ...
        /* update the log file --- this is used to see whether the process is still running */
            ...
            fo  = fopen("/data/mta4/Script/SOH/Logs/soh_main_log", "a");
    ...
    fprintf(fo, "\t\tnohup /data/mta4/Script/SOH/soh_main_daemonize &\n\n");
